...
Run from the project root with:
    ...
    python mask_aware_tf_heavy/smoke_test_pseudo.py
"""
import sys
import os
...
from mask_aware_tf_heavy.mat_pseudo_lwm import mask_patches
...
from mask_aware_tf_heavy import MATPseudoLWM  # noqa
print("  ✓ MATPseudoLWM importable from mask_aware_tf_heavy")
