...
# Reuse MATStage, ATB, and WindowMHA from Method 1
from .mat_vit_lwm import MATStage, ATB, WindowMHA
...
class MATPseudoLWM(nn.Module):
    ...
    def __init__(
        ...
        self.stage1 = MATStage(d_model, heads=heads, win=win)
        self.stage2 = MATStage(d_model, heads=heads, win=win)
        self.stage3 = MATStage(d_model, heads=heads, win=win)
